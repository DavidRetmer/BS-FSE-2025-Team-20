# Generated by Django 4.2.18 on 2025-01-22 05:25
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location_longitude', models.DecimalField(decimal_places=6, max_digits=9, null=True)),
                ...
                ('availability_time_slots', models.JSONField(default=list)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('skill_level_filter', models.CharField(blank=True, choices=[('beginner', 'Beginner'), ('intermediate', 'Intermediate'), ('advanced', 'Advanced')], max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ratings', to='community.event')),
